...
//BOX_RIGHT_FLAG
struct box a1 = {
  15, A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, NULL};
struct box a2 = {
  14, A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &a1};
struct box a3 = {
  13, A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &b4, &a2};
struct box a4 = {
  12, A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &a3};
struct box a5 = {
  11, A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &a6, &a4};
struct box a6 = {
  10, A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &b7, &a5};
struct box a7 = {
  9,  A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &a6};
struct box a8 = {
  8,  A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &a7};

struct box b1 = {
  7,  A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &a3, &a8};
struct box b2 = {
  6,  A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &b1};
struct box b3 = {
  5,  A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &b2};
struct box b4 = {
  4,  A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &b5, &b3};
struct box b5 = {
  3,  A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &a5, &b4};
struct box b6 = {
  2,  A_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &b5};
struct box b7 = {
  1,  A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &b8, &b6};
struct box b8 = {
  0,  A_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &d8, &b7};

struct box c1 = {
  23, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &b8};
struct box c2 = {
  22, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &c1};
struct box c3 = {
  21, D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &d1, &c2};
struct box c4 = {
  20, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &c3};
struct box c5 = {
  19, D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &d4, &c4};
struct box c6 = {
  18, D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &c5, &c5};
struct box c7 = {
  17, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &c6};
struct box c8 = {
  16, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &c7};

struct box d1 = {
  6,  D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, NULL, &c8};
struct box d2 = {
  7,  D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &d1};
struct box d3 = {
  8,  D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &d2};
struct box d4 = {
  9,  D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &c3, &d3};
struct box d5 = {
  10, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &d4};
struct box d6 = {
  11, D_PIN, BOX_WRONG_FLAG, BOX_UP_FLAG, NULL, &d5};
struct box d7 = {
  12, D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &c6, &d6};
struct box d8 = {
  13, D_PIN, BOX_RIGHT_FLAG, BOX_UP_FLAG, &d7, &d7};
...
static void light_init_effect(void)
{

}

static void floor_light_hint(void)
{

}

static void floor_light_on(int num)
{
